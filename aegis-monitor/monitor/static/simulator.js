...
(function () {
    ...
    // ---- HTML tooltip (persists on hover) ----
    var hoverTooltip = null;
    var hideTimer = null;

    function setupTooltip(container, sigma, graph) {
        hoverTooltip = document.createElement("div");
        hoverTooltip.className = "graph-tooltip";
        ...
        sigma.on("enterNode", function (e) {
            ...
            var pos = sigma.graphToViewport(attrs);
            hoverTooltip.textContent = attrs.label || e.node;
        ...
        hoverTooltip.addEventListener("mouseleave", function () {
            hoverTooltip.classList.remove("visible");
        });
    }
    ...
    function initGraph() {
        ...
        setupTooltip(container, sigmaInstance, graphInstance);
    }
